 ...
 * @author User
 */
public class DijkstraSolmu implements Solmu, Comparable<DijkstraSolmu> {
    ...
    public DijkstraSolmu(int arvo, double x, double y, String nimi) {
    ...
    @Override
    public int compareTo(DijkstraSolmu t) {
